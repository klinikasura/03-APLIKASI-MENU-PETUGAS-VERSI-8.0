...
<body>
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        <div class="logo"><h1>Dashboard BPJS</h1></div>
    ...
    <iframe src="http://192.168.88.203/dashboard/BPJS/bpjs.png" name="frame" width="100%" height="600px" allowtransparency="true" noresize="noresize"></iframe>
          </ol>
