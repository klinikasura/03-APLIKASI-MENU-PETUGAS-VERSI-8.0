<!DOCTYPE html><head>
	...
	<link href="http://192.168.88.203/dashboard/download.jpeg" rel="icon" type="image/png" />
	 <meta http-equiv="refresh" content="8;url=http://192.168.88.203/dashboard/DATA/index.php">
...
<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-login-form-2" role="form" action="#" method="post">
				<div class="row">
					<div class="col-md-12">
						<h1 align="center">Development Program </h1>
					</div>
				</div>
		  <div class="row">
					<div class="templatemo-one-signin col-md-6">
				        ...
				        <div class="form-group">
				          <div class="col-md-12"><a href="http://192.168.88.203/dashboard/RIVIEW/index.php">LOGIN</a></div>
				        </div>
			          <div class="form-group"></div>
					</div>
			        <img src="download.jpeg" width="287" height="235"></div>
			</form>		      		      
		</div>
	</div>
	<script> 
