...
<head>
    ...
    <!-- Meta START -->
    <link rel="icon" href="assets/assets/img/rs.png" type="image/x-icon">
    <meta charset="utf-8" />
    ...
    <!-- Global style START -->
    <link type="text/css" rel="stylesheet" href="assets/assets/css/materialize.min.css"  media="screen,projection"/>
    <link type="text/css" rel="stylesheet" href="assets/assets/css/jquery-ui.css"  media="screen,projection"/>
    <link rel="stylesheet" href="assets/assets/css/marquee.css" />
    <link rel="stylesheet" href="assets/assets/css/example.css" />
    <link rel="stylesheet" href="assets/assets/css/ok.css" />
    <style type="text/css">
        .bg::before {
            content: '';
...
<!-- Javascript START -->
<script type="text/javascript" src="assets/assets/js/jquery-2.1.1.min.js"></script>
<script type="text/javascript" src="assets/assets/js/materialize.min.js"></script>
<script type="text/javascript" src="assets/assets/js/jquery-ui.min.js"></script>
...
<script type="text/javascript" src="assets/assets/js/marquee.js"></script>
