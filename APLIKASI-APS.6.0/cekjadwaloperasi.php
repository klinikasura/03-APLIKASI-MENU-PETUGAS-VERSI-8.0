...
<center><button id="goFS">KLIK LAYAR PENUH</button>
<button type="button" class="get_bg">
 <a href="http://192.168.88.203/dashboard/APLIKASI-APS.6.0/POLIKLINIK" >POLIKLINIK</a>
</button></center>
<p></p>
...
<head>
    ...
    <title>CEK JADWAL OPERASI</title>

    <!-- Meta START -->
    <link rel="icon" href="assetsoperasi/assets/img/rs.png" type="image/x-icon">
    <meta charset="utf-8" />
    ...
    <!-- Global style START -->
    <link type="text/css" rel="stylesheet" href="assetsoperasi/assets/css/materialize.min.css"  media="screen,projection"/>
    <link type="text/css" rel="stylesheet" href="assetsoperasi/assets/css/jquery-ui.css"  media="screen,projection"/>
    <link rel="stylesheet" href="assetsoperasi/assets/css/marquee.css" />
    <link rel="stylesheet" href="assetsoperasi/assets/css/example.css" />
    <link rel="stylesheet" href="assetsoperasi/assets/css/ok.css" />
    <style type="text/css">
        .bg::before {
            content: '';
            background-image: url('./assetsoperasi/img/operasi.jpg');
...
<nav class="deep-orange accent-3">
    <div class="nav-wrapper">
        <ul class="center hide-on-med-and-down" id="nv">
            <li>
                <a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">local_hospital</i> CEK JADWAL OPERASI</a>
            </li>
...
<!-- Javascript START -->
<script type="text/javascript" src="assetsoperasi/assets/js/jquery-2.1.1.min.js"></script>
<script type="text/javascript" src="assetsoperasi/assets/js/materialize.min.js"></script>
<script type="text/javascript" src="assetsoperasi/assets/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="assetsoperasi/assets/js/bootstrap.min.js"></script>
<script data-pace-options='{ "ajax": false }' src='assetsoperasi/js/pace.min.js'></script>
<script type="text/javascript" src="assetsoperasi/assets/js/marquee.js"></script>
